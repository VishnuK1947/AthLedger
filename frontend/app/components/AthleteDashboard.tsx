      ...
      <main className="p-4 md:p-6 space-y-6">
        ...
        <div className="grid gap-6">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="h-[392px]">
              <CardHeader>
                <CardTitle className="text-lg font-medium">Recommended Clients</CardTitle>
              </CardHeader>
              <CardContent className="h-[300px] overflow-y-auto pr-4">
                <div className="space-y-4">
                  {[
                    { name: 'Nike Sports', description: 'Global athletic wear company' },
                    { name: 'ESPN Analytics', description: 'Sports data research firm' },
                    { name: 'Team USA Olympic', description: 'National Olympic committee' },
                    { name: 'Sports Science Lab', description: 'Performance research institute' },
                    { name: 'Gatorade Research', description: 'Sports nutrition company' },
                    { name: 'Under Armour', description: 'Athletic equipment manufacturer' },
                    { name: 'NBA Analytics', description: 'Basketball statistics division' },
                    { name: 'Red Bull Sports', description: 'Performance tracking team' },
                    { name: 'Adidas Innovation', description: 'Sports technology research' },
                    { name: 'Stanford Athletics', description: 'University sports program' },
                  ].map((client, index) => (
          ...
          <Card className="h-[800px]">
            ...
            <CardContent className="space-y-8">
              ...
              <div>
                <h3 className="text-base font-semibold mb-4">Best Stats</h3>
              ...
              <div>
                <div className="grid grid-cols-12 gap-4 px-4 mb-4">
                  <div className="col-span-5 text-xs font-medium text-muted-foreground">Metric</div>
                  <div className="col-span-4 text-xs font-medium text-muted-foreground">Privacy</div>
                  <div className="col-span-3 text-xs font-medium text-muted-foreground">Change</div>
                </div>
                <div>
                  <div className="h-[220px] overflow-y-auto pr-4">
                    {metrics.map((metric, index) => (
                      <div 
                        key={index} 
                        className="grid grid-cols-12 items-center gap-4 px-4 py-3 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors"
                      >
                        ...
                        <div className="col-span-4 flex items-center space-x-2">
                          <Switch 
                            className="data-[state=checked]:bg-gray-900 h-4 w-8"
                        ...
                        <div className="col-span-3 flex items-center justify-between">
                          <span className={`rounded-full ${getChangeColor(metric.changeType)} px-2 py-0.5 text-xs`}>
                            {metric.change}
                          </span>
